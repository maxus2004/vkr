...
- спроектировать программную архитектуру системы с разделением задач между бортовым компьютером и сервером;
...
- разработать методику тестирования системы в условиях деградации отдельных источников данных из за погодных условий;
- провести комплексное тестирование в макете города.